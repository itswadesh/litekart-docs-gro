...
export default {
  ...
  head() {
    const title = 'Design Resources - Litekart'
    const description =
      'Download Litekart design resources (SVG, icons, emoji and favicon).'
