<template>
  ...
  >
    ...
    >
      ...
      >
        <div
          class="lg:text-center flex flex-col items-center lg:w-full sm:w-1/3"
        >
          <p
          ...
          <a
            ...
            :key="sponsor.name"
            :href="sponsor.link"
            class="flex justify-center my-4 w-48 lg:w-full "
  ...
  data() {
    return {
      sponsors: [
        {
          name: 'FontednFun',
          link: 'https://www.frontendfun.com/?ref=litekart-gro',
          img: 'frontendfun-logo.svg'
        }
      ]
    }
  }
